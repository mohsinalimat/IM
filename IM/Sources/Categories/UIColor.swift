...
extension UIColor {
    ...
    public class func im_messageBubbleGreenColor() -> UIColor {
        
        return UIColor(hue: 130/360, saturation:0.68, brightness:0.84, alpha:1)
    }
    
    public class func im_messageBubbleBlueColor() -> UIColor {
        
        return UIColor(hue: 210/360, saturation:0.94, brightness:1, alpha:1)
    }
    
    public class func im_messageBubbleRedColor() -> UIColor {
        
        return UIColor(hue: 0, saturation:0.79, brightness:1, alpha:1)
    }
    
    public class func im_messageBubbleLightGrayColor() -> UIColor {
    ...
    public func im_colorByDarkeningColorWithValue(_ value: CGFloat) -> UIColor {
