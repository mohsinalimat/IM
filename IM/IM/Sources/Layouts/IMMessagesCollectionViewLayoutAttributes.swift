//
//  IMMessagesCollectionViewLayoutAttributes.swift
...
open class IMMessagesCollectionViewLayoutAttributes: UICollectionViewLayoutAttributes {
    ...
    open override func isEqual(_ object: Any?) -> Bool {
        ...
        if self.representedElementCategory == .cell {
            ...
            if let layoutAttributes = object as? IMMessagesCollectionViewLayoutAttributes {
    ...
    open override func copy(with zone: NSZone?) -> Any {
        ...
        if let copy = copy as? IMMessagesCollectionViewLayoutAttributes {
