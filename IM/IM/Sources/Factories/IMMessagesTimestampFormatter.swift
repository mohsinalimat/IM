//
//  IMMessagesTimestampFormatter.swift
...
open class IMMessagesTimestampFormatter: NSObject {
    ...
    open static let sharedFormatter: IMMessagesTimestampFormatter = IMMessagesTimestampFormatter()
